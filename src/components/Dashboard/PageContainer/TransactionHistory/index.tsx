...
const TransactionTable: React.FC<TransactionTableProps> = ({
  ...
  return (
    <>
      <div className="block font-graphik text-[24px] text-black dark:text-white mt-4 leading-28 font-medium tracking-normal ">
        {t('History')}
      </div>
      <div className="dark:bg-slate-900 shadow-3xl mt-2 rounded-[12px] text-white dark:text-white">

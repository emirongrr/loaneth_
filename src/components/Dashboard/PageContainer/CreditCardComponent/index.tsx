...
const CreditCardForm = () => {
  return (
        <div className="items-center flex">
          ...
          <img className="absolute top-[20px] left-[20px] w-[35px] h-[35px]"src='/svg/chip.png'></img>
...
<svg version="1.1" id="visa" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
                 width="47.834px" height="47.834px"  viewBox="0 0 47.834 47.834">
                        <g>
                            <path fill="#FFFF" d="M44.688,16.814h-3.004c-0.933,0-1.627,0.254-2.037,1.184l-5.773,13.074h4.083c0,0,0.666-1.758,0.817-2.143
            ...
            <div  className="absolute  top-[103px] left-[19px] text-3xl">1234 5678 9101 1122</div>
            ...
            <div className="absolute right-[20px] top-[180px] text-sm text-right">
              ...
              <div className="text-white">12/23</div>
            </div>
          </div>
          </div>
  );
